...
def main():
    ...
    for game in game_names:
        ...
        # Best official offer (from official stores or trusted retailers)
        ...
        # Best current overall offer (best_offer)
        ...
        print(f"  - Best Overall Offer: {offer_price} EUR, Link: {offer_link}, Voucher: {offer_voucher}")
